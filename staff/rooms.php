    ...
    if (!$error) {
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($number == $row['number']) {
                $err =  "Phòng với số này đã tồn tại";
            } else {
                //
            }
        } else {
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $rooms->price; ?> VNĐ</td>
                                        <td>
                                            ...
                                            <div class="modal fade" id="view-<?php echo $rooms->id; ?>">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Chi tiết phòng <?php echo $rooms->number; ?></h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Đóng">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                            ...
                                            <!-- Kết thúc Xem chi tiết Modal -->

                                            <!-- Không cho phép xóa/cập nhật phòng đã có khách -->
                                            <?php
                                            if ($rooms->status == 'Occupied' || $rooms->status == 'Đã có khách') {
                                            } else {
