                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    } elseif ($attendance->status == 'Muộn') {
                                                        echo "<span class='badge bg-warning'>Muộn</span>";
                                                    } elseif ($attendance->status == 'Vắng mặt') {
                                                        echo "<span class='badge bg-danger'>Vắng mặt</span>";
                                                    } elseif ($attendance->status == 'Nửa ngày') {
                                                        echo "<span class='badge bg-info'>Nửa ngày</span>";
                                                    } else {
                                                ...
                                                <td>
                                                    <a href="#update-<?php echo $attendance->id; ?>" data-toggle="modal" class="badge bg-primary"><i class="fas fa-edit"></i> Cập nhật</a>
                                                    <a href="#delete-<?php echo $attendance->id; ?>" data-toggle="modal" class="badge bg-danger text-danger"><i class="fas fa-trash"></i> Xóa</a>
                                                </td>
                                            </tr>
                                            <!-- Modal Cập nhật -->
                                            <div class="modal fade" id="update-<?php echo $attendance->id; ?>" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel<?php echo $attendance->id; ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="updateModalLabel<?php echo $attendance->id; ?>">Cập nhật chấm công</h5>
                                            ...
                                            <!-- Modal Xóa -->
                                            <div class="modal fade" id="delete-<?php echo $attendance->id; ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel<?php echo $attendance->id; ?>" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteModalLabel<?php echo $attendance->id; ?>">XÁC NHẬN</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Đóng">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body text-center text-danger">
                                                            <h4>Bạn có chắc muốn xóa chấm công của <?php echo $attendance->staff_name; ?> ngày <?php echo $attendance->date; ?>?</h4>
                                                            <br>
                                                            <button type="button" class="btn btn-success" data-dismiss="modal">Không</button>
                                                            <a href="attendance.php?Delete_Attendance=<?php echo $attendance->id; ?>" class="btn btn-danger"> Xóa </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
